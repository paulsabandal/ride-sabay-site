...
!function webpackUniversalModuleDefinition(e, t) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof3(exports)) && "object" == (typeof module === "undefined" ? "undefined" : _typeof3(module)) ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof3(exports)) ? exports.bulmaCollapsible = t() : e.bulmaCollapsible = t();
}(window, function () {
  return function (e) {
    var t = {};function __webpack_require__(n) {
      ...
      if (1 & t && (e = __webpack_require__(e)), 8 & t) return e;if (4 & t && "object" == (typeof e === "undefined" ? "undefined" : _typeof3(e)) && e && e.__esModule) return e;var n = Object.create(null);if (__webpack_require__.r(n), Object.defineProperty(n, "default", { enumerable: !0, value: e }), 2 & t && "string" != typeof e) for (var r in e) {
    ...
    var r = n(8);e.exports = function _objectSpread(e) {
    ...
    var r = n(6),
        o = n(4);e.exports = function _possibleConstructorReturn(e, t) {
      return !t || "object" !== r(t) && "function" != typeof t ? o(e) : t;
    };
  }, function (e, t) {
    function _typeof2(e) {
      return (_typeof2 = "function" == typeof Symbol && "symbol" == _typeof3(Symbol.iterator) ? function _typeof2(e) {
    ...
    var r = n(11);e.exports = function _inherits(e, t) {
    ...
    n(0);var r = n(10);function _get(t, n, o) {
    ...
    var r = n(0);e.exports = function _superPropBase(e, t) {
    ...
    n.r(t);var r = n(1),
      ...
      function EventEmitter() {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [];o()(this, EventEmitter), this._listeners = new Map(e), this._middlewares = new Map();
      }return s()(EventEmitter, [{ key: "listenerCount", value: function listenerCount(e) {
          return this._listeners.has(e) ? this._listeners.get(e).length : 0;
        } }, { key: "removeListeners", value: function removeListeners() {
          var e = this,
              t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
              n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];null !== t ? Array.isArray(t) ? name.forEach(function (t) {
            return e.removeListeners(t, n);
          }) : (this._listeners.delete(t), n && this.removeMiddleware(t)) : this._listeners = new Map();
        } }, { key: "middleware", value: function middleware(e, t) {
          var n = this;Array.isArray(e) ? name.forEach(function (e) {
          ...
          var e = this,
              t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null;null !== t ? Array.isArray(t) ? name.forEach(function (t) {
            return e.removeMiddleware(t);
          }) : this._middlewares.delete(t) : this._middlewares = new Map();
        } }, { key: "on", value: function on(e, t) {
          var n = this,
              r = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];if (Array.isArray(e)) e.forEach(function (e) {
            return n.on(e, t);
          });else {
            var o = (e = e.toString()).split(/,|, | /);o.length > 1 ? o.forEach(function (e) {
              return n.on(e, t);
            }) : (Array.isArray(this._listeners.get(e)) || this._listeners.set(e, []), this._listeners.get(e).push({ once: r, callback: t }));
          }
        } }, { key: "once", value: function once(e, t) {
          this.on(e, t, !0);
        } }, { key: "emit", value: function emit(e, t) {
          var n = this,
              r = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];e = e.toString();var o = this._listeners.get(e),
              i = null,
              s = 0,
              l = r;if (Array.isArray(o)) for (o.forEach(function (a, c) {
            r || (i = n._middlewares.get(e), Array.isArray(i) ? (i.forEach(function (n) {
              n(t, function () {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null;null !== e && (t = e), s++;
              }, e);
      ...
      var e = !1;if ("undefined" != typeof window && "function" == typeof window.addEventListener) {
        var t = Object.defineProperty({}, "passive", { get: function get() {
            return e = !0, !0;
          } }),
            n = function noop() {};window.addEventListener("testPassive", n, t), window.removeEventListener("testPassive", n, t);
      }return e;
    },
      ...
      var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};return E(e) && e.dataset ? Object.keys(e.dataset).filter(function (e) {
        return Object.keys(t).includes(e);
      }).reduce(function (t, n) {
        return m()({}, t, w()({}, n, e.dataset[n]));
      }, {}) : {};
    };"undefined" == typeof Node || Node.prototype.on || (Node.prototype.on = function (e, t) {
      var n = this;return Array.isArray(e) || (e = e.split(" ")), e.forEach(function (e) {
      ...
      function Component(e) {
        var t,
          ...
          var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};if ("string" == typeof e) {
            if (void 0 === this[e]) throw new TypeError('No method named "'.concat(e, '"'));return this[e](e);
          }return this;
        } }]), Component;
    }(b),
        M = { allowMultiple: !1, container: "undefined" != typeof document ? document : null };n.d(t, "default", function () {
      return T;
    });var T = function (e) {
      function bulmaCollapsible(e) {
        var t,
            n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};return o()(this, bulmaCollapsible), (t = a()(this, p()(bulmaCollapsible).call(this, e, n, M))).onTriggerClick = t.onTriggerClick.bind(u()(t)), t._init(), t;
      }return y()(bulmaCollapsible, e), s()(bulmaCollapsible, [{ key: "_init", value: function _init() {
          if (this._parent = this.element.dataset.parent, this._parent) {
            var e = this.options.container.querySelector("#".concat(this._parent));this._siblings = q(this.options.selector, e) || [];
          ...
          var e = this;(void 0 === this._collapsed || this._collapsed) && (this.emit("before:expand", this), this._parent && !function BooleanParse(e) {
            return !j.test(e) && !!e;
          ...
          this.collapse();
        } }, { key: "onTriggerClick", value: function onTriggerClick(e) {
          ...
          var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : ".is-collapsible",
              t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};return _()(p()(bulmaCollapsible), "attach", this).call(this, e, t, M);
        } }]), bulmaCollapsible;
    }(N);
  }]).default;
});